...
{   /*This class represents Hello World */
    class Program
    {
        ...
        public static void Advanced_C_Sharp()
        {
            ...
            do
            {
                ...
                Console.WriteLine("14 - delegateExample");
                Console.WriteLine("15 - AnonymousTypeExample");
                Console.WriteLine("16 - ReadWrite");
                Console.WriteLine("17 - x");
                Console.WriteLine("18 - x");
                Console.WriteLine("Q - Quit\n");
                Console.WriteLine("Choice (1 - 18 or Q): ");
                ...
                switch (myChoice)
                {
                    ...
                    case "13":
                        ...
                        break;
                    case "14":
                        Console.WriteLine("You wish to run delegateExample");
                        DelegateExample();
                        break;
                    case "15":
                        ...
                        break;
                    case "16":
                        Console.WriteLine("You wish to run ReadWrite");
                        ReadWrite();
                        break;
                    case "Q":
                    case "q":
    ...
    public void xyz()
        ...
        {
            //ReadWrite myReadWrite = new ReadWrite();
         //   CreateFileOrFolder myNewFileOrFolder = new CreateFileOrFolder();
            BeepSong myBeepSong = new BeepSong();
        }
    }
}
