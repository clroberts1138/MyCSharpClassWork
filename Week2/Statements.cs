...
{
    /**
     * Their are four types of Statements covered in this class.
    ...
    {
        /**
         * Declaration statements comprise of new variables with optional initialization.
         * Multiples of the same type can be declared, separated by a colon.
         * A const declaration can be created by not altered.
         * **/
        ...
        public void WhileLoopExample()
        {
            ...
            while (i < 10) // While this expression is true
            {
                ...
                Console.WriteLine(_something + i); 
                i++;
            }
        }
